...
#	 set_property IOSTANDARD LVCMOS33 [get_ports {rst}]
# set_property PACKAGE_PIN V15 [get_ports {cntrl[0]}]					
#	 set_property IOSTANDARD LVCMOS33 [get_ports {cntrl[0]}]
# set_property PACKAGE_PIN W14 [get_ports {cntrl[1]}]					
...
#	 set_property IOSTANDARD LVCMOS33 [get_ports {serial_in}]
 #set_property PACKAGE_PIN V2 [get_ports {serial_in}]					
	 #set_property IOSTANDARD LVCMOS33 [get_ports {serial_in}]
# set_property PACKAGE_PIN T3 [get_ports {cntrl[1]}]					
#	 set_property IOSTANDARD LVCMOS33 [get_ports {cntrl[1]}]
